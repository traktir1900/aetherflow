...
def _install_crown_sanctum():
    ...
    def wrapper(*args, **kwargs):
        ...
        if ctx is not None:
            ...
            # Crown is a PvE boss objective, not a normal capture point.
            # Keep the Lord/BossButton sanctuary and remove only the generic
            # Crown capture platform generated by the capture-point pass.
