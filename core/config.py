...
CONFIG = {
    ...
    "resource_foundation": {"enabled": True, "speed_anchor_t": 0.52, "health_anchor_t": 0.52,
        "speed_offset_y": -3.5, "health_offset_y": -3.5, "speed_shrine_radius": 2.8,
        "health_relic_radius": 2.4, "require_exact_mirror": True},
    ...
    "world_silhouette": {"enabled": True, "symmetry_required": True, "navigation_blocking": False},
    "circle_segments": 28,
}
