...
CONFIG = {
    ...
    "terrain_refinement": {
        "enabled": True, "core_depth_multiplier": 1.65,
    ...
    "height_transitions": {
        "combat_max_deg": 15.0, "minion_safe_max_deg": 18.0,
        "walkable_max_deg": 25.0, "ramp_max_deg": 30.0,
        "hard_max_deg": 35.0, "max_step_m": 0.75,
        "min_group_width_m": 4.0, "minion_corridor_width_m": 1.30,
    },
    "gameplay_symmetry": {
        "enabled": True,
        "rule": "ALL_TEAM_CRITICAL_GEOMETRY_MUST_BE_MIRROR_SYMMETRIC",
        "plane": "Y_AXIS", "transform": "(x,y,z) -> (-x,y,z)", "tolerance_m": 0.25,
        "apply_to": ["bases", "capture_points", "roads", "ramps", "pockets",
    ...
    "turret_offset": _gs(27.5), "turret_radius_base": _gs(4.5),
    "turret_radius_top": _gs(2.25), "turret_depth": _gs(10.0),
    "turret_z_offset": _gs(5.0),
    "altar": {"base_radius1": _gs(4.5), "base_radius2": _gs(4.0),
              "base_depth": _gs(0.8), "crown_radius": _gs(1.4), "crown_z": _gs(2.0)},
    "choke_rock": {"radius1": _gs(2.8), "radius2": _gs(1.5), "depth": _gs(4.5),
                    "lateral_extra": _gs(2.5), "z_offset": _gs(2.25)},
    "core_cover": {
        "north_pillar_size": tuple(_gs(v) for v in (6.25, 6.25, 8.75)),
        "north_pillar_offset": _gs(2.5),
        "side_wall_main": tuple(_gs(v) for v in (10.0, 3.0, 6.25)),
    ...
    "simulation": {"agent_speed": _s(6.0), "agents_per_route": 12,
    ...
    "validation": {"bounds_margin": _s(6.0), "max_object_height": _s(30.0),
                    ...
                    "require_gameplay_symmetry": True, "gameplay_symmetry_tolerance_m": 0.25},
    "scene": {"allow_scene_reset": False,
              "managed_collections": ["Terrain", "Bases", "CapturePoints", "Roads", "Ramps",
                                      "Decorations", "Rocks", "CoreCover", "Pockets", "DebugSightlines"]},
    "pockets": {
        "enabled": True, "center_radius": _s(165.0), "entry_width": _p(30.0),
        "entry_gate": {"target_width": _p(10.0), "rock_radius": _p(1.3),
                        "irregularity": 0.04, "height": _p(2.4)},
        "rock_arc": {
            "span_deg": 168.0, "target_spacing": _p(7.95), "min_segments": 22, "max_segments": 30,
            ...
            "fortified_fence": {
                "enabled": True, "anchor_every_v3": 2, "wall_height_v3": _p(1.72),
                "terminal_height_v3": _p(1.48), "wall_thickness_v3": _p(0.88),
                "wall_outward_offset_v3": _p(0.64), "foundation_thickness_v3": _p(0.92),
                "foundation_height_v3": _p(0.36), "cap_height_v3": _p(0.28),
                "cap_overhang_v3": _p(0.12), "anchor_post_thickness_v3": _p(0.24),
                "anchor_post_height_v3": _p(1.88), "brace_thickness_v3": _p(0.075),
                "aether_every_v3": 4, "structure_seed": 7349,
            },
        },
    ...
    "outer_boundary": {
        ...
        "wall_thickness_min": 3.0, "wall_thickness_max": 6.0, "internal_depth_factor": 1.0,
        "outer_clearance_min": 0.0, "section_overlap_factor": 1.12, "seed": 42017,
    },
    "circle_segments": 28,
}
